...
const InspirationThree = ({ inspirationThreeOpenPopup, initialPosition }) => {
  ...
  const handleClose = (e) => {
    e && e.stopPropagation();
    inspirationThreeOpenPopup(false);
  };
  ...
  return (
    ...
    >
      ...
      <img 
        src="/media/InspirationThree.webp" 
        alt="I" 
      ...
      >
        {isExpanded && (
          <div style={{ 
            ...
            <h3 style={{ color: "#0000ff", fontSize: "20px", marginTop: "-3px" }}> Photo/Three </h3>
